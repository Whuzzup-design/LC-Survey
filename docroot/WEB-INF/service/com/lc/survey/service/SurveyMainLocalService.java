...
/**
 * Provides the local service interface for SurveyMain. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author kevin
 * @see SurveyMainLocalServiceUtil
...
public interface SurveyMainLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SurveyMainLocalServiceUtil} to access the survey main local service. Add custom service methods to {@link com.lc.survey.service.impl.SurveyMainLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
