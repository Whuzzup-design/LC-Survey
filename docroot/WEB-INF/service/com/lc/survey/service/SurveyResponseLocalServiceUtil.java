...
/**
 * Provides the local service utility for SurveyResponse. This utility wraps
 * {@link com.lc.survey.service.impl.SurveyResponseLocalServiceImpl} and is the
 ...
 * @see com.lc.survey.service.impl.SurveyResponseLocalServiceImpl
 * @generated
 */
public class SurveyResponseLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.lc.survey.service.impl.SurveyResponseLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.lc.survey.model.SurveyResponse addSurveyResponse(
		com.lc.survey.model.SurveyResponse surveyResponse)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addSurveyResponse(surveyResponse);
	}
	...
	*/
	public static com.lc.survey.model.SurveyResponse createSurveyResponse(
		long surveyResponseId) {
		return getService().createSurveyResponse(surveyResponseId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lc.survey.model.SurveyResponse deleteSurveyResponse(
		long surveyResponseId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSurveyResponse(surveyResponseId);
	}
	...
	*/
	public static com.lc.survey.model.SurveyResponse deleteSurveyResponse(
		com.lc.survey.model.SurveyResponse surveyResponse)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSurveyResponse(surveyResponse);
	}
	...
	*/
	...
	public static com.lc.survey.model.SurveyResponse fetchSurveyResponse(
		long surveyResponseId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchSurveyResponse(surveyResponseId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lc.survey.model.SurveyResponse getSurveyResponse(
		long surveyResponseId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSurveyResponse(surveyResponseId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.lc.survey.model.SurveyResponse> getSurveyResponses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSurveyResponses(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getSurveyResponsesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSurveyResponsesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.lc.survey.model.SurveyResponse updateSurveyResponse(
		com.lc.survey.model.SurveyResponse surveyResponse)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSurveyResponse(surveyResponse);
	}
	...
	*/
	...
	public static void updateSurveyResponse(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		getService()
			.updateSurveyResponse(surveyResponse, surveyMainId, writerId,
			response, userId, date);
	}
	...
	public static java.util.List<com.lc.survey.model.SurveyResponse> findByWriterId(
		long writerId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByWriterId(writerId);
	}
	...
	public static int countByWriterId(long writerId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().countByWriterId(writerId);
	}
	...
	public static SurveyResponseLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SurveyResponseLocalService.class.getName());

			if (invokableLocalService instanceof SurveyResponseLocalService) {
				_service = (SurveyResponseLocalService)invokableLocalService;
			}
			else {
				_service = new SurveyResponseLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(SurveyResponseLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(SurveyResponseLocalService service) {
	}

	private static SurveyResponseLocalService _service;
}