...
/**
 * Provides the local service interface for SurveyFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author kevin
 * @see SurveyFileLocalServiceUtil
...
public interface SurveyFileLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SurveyFileLocalServiceUtil} to access the survey file local service. Add custom service methods to {@link com.lc.survey.service.impl.SurveyFileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
