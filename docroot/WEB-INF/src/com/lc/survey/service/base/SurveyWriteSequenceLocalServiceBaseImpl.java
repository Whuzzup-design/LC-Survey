...
import com.lc.survey.service.SurveyWriteSequenceLocalService;
...
/**
 * Provides the base implementation for the survey write sequence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lc.survey.service.impl.SurveyWriteSequenceLocalServiceImpl}.
 * </p>
 *
 * @author kevin
 ...
 * @generated
 */
public abstract class SurveyWriteSequenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SurveyWriteSequenceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lc.survey.service.SurveyWriteSequenceLocalServiceUtil} to access the survey write sequence local service.
	 */
	...
	@Override
	public SurveyWriteSequence addSurveyWriteSequence(
		SurveyWriteSequence surveyWriteSequence) throws SystemException {
		surveyWriteSequence.setNew(true);

		return surveyWriteSequencePersistence.update(surveyWriteSequence);
	}
	 ...
	 */
	@Override
	public SurveyWriteSequence createSurveyWriteSequence(
		long surveyWriteSequenceId) {
		return surveyWriteSequencePersistence.create(surveyWriteSequenceId);
	}
	...
	@Override
	public SurveyWriteSequence deleteSurveyWriteSequence(
		long surveyWriteSequenceId) throws PortalException, SystemException {
		return surveyWriteSequencePersistence.remove(surveyWriteSequenceId);
	}
	...
	public SurveyWriteSequence deleteSurveyWriteSequence(
		SurveyWriteSequence surveyWriteSequence) throws SystemException {
		return surveyWriteSequencePersistence.remove(surveyWriteSequence);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SurveyWriteSequence.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return surveyWriteSequencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return surveyWriteSequencePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SurveyWriteSequence fetchSurveyWriteSequence(
		long surveyWriteSequenceId) throws SystemException {
		return surveyWriteSequencePersistence.fetchByPrimaryKey(surveyWriteSequenceId);
	}
	 ...
	 */
	@Override
	public SurveyWriteSequence getSurveyWriteSequence(
		long surveyWriteSequenceId) throws PortalException, SystemException {
		return surveyWriteSequencePersistence.findByPrimaryKey(surveyWriteSequenceId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return surveyWriteSequencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SurveyWriteSequence> getSurveyWriteSequences(int start, int end)
		throws SystemException {
		return surveyWriteSequencePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSurveyWriteSequencesCount() throws SystemException {
		return surveyWriteSequencePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SurveyWriteSequence updateSurveyWriteSequence(
		SurveyWriteSequence surveyWriteSequence) throws SystemException {
		return surveyWriteSequencePersistence.update(surveyWriteSequence);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.lc.survey.model.SurveyWriteSequence",
			surveyWriteSequenceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = surveyWriteSequencePersistence.getDataSource();
	...
	private SurveyWriteSequenceLocalServiceClpInvoker _clpInvoker = new SurveyWriteSequenceLocalServiceClpInvoker();
}