...
import com.lc.survey.service.SurveyWriterLocalService;
...
/**
 * Provides the base implementation for the survey writer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lc.survey.service.impl.SurveyWriterLocalServiceImpl}.
 * </p>
 *
 * @author kevin
 ...
 * @generated
 */
public abstract class SurveyWriterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SurveyWriterLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lc.survey.service.SurveyWriterLocalServiceUtil} to access the survey writer local service.
	 */
	...
	@Override
	public SurveyWriter addSurveyWriter(SurveyWriter surveyWriter)
		throws SystemException {
		surveyWriter.setNew(true);

		return surveyWriterPersistence.update(surveyWriter);
	}
	 ...
	 */
	@Override
	public SurveyWriter createSurveyWriter(long surveyWriterId) {
		return surveyWriterPersistence.create(surveyWriterId);
	}
	...
	@Override
	public SurveyWriter deleteSurveyWriter(long surveyWriterId)
		throws PortalException, SystemException {
		return surveyWriterPersistence.remove(surveyWriterId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SurveyWriter deleteSurveyWriter(SurveyWriter surveyWriter)
		throws SystemException {
		return surveyWriterPersistence.remove(surveyWriter);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SurveyWriter.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return surveyWriterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return surveyWriterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SurveyWriter fetchSurveyWriter(long surveyWriterId)
		throws SystemException {
		return surveyWriterPersistence.fetchByPrimaryKey(surveyWriterId);
	}
	 ...
	 */
	@Override
	public SurveyWriter getSurveyWriter(long surveyWriterId)
		throws PortalException, SystemException {
		return surveyWriterPersistence.findByPrimaryKey(surveyWriterId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return surveyWriterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SurveyWriter> getSurveyWriters(int start, int end)
		throws SystemException {
		return surveyWriterPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSurveyWritersCount() throws SystemException {
		return surveyWriterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SurveyWriter updateSurveyWriter(SurveyWriter surveyWriter)
		throws SystemException {
		return surveyWriterPersistence.update(surveyWriter);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.lc.survey.model.SurveyWriter",
			surveyWriterLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = surveyWriterPersistence.getDataSource();
	...
	private SurveyWriterLocalServiceClpInvoker _clpInvoker = new SurveyWriterLocalServiceClpInvoker();
}