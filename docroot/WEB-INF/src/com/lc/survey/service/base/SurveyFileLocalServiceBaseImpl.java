...
import com.lc.survey.service.SurveyFileLocalService;
...
/**
 * Provides the base implementation for the survey file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.lc.survey.service.impl.SurveyFileLocalServiceImpl}.
 * </p>
 *
 * @author kevin
 ...
 * @generated
 */
public abstract class SurveyFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SurveyFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.lc.survey.service.SurveyFileLocalServiceUtil} to access the survey file local service.
	 */
	...
	@Override
	public SurveyFile addSurveyFile(SurveyFile surveyFile)
		throws SystemException {
		surveyFile.setNew(true);

		return surveyFilePersistence.update(surveyFile);
	}
	 ...
	 */
	@Override
	public SurveyFile createSurveyFile(long surveyFileId) {
		return surveyFilePersistence.create(surveyFileId);
	}
	...
	@Override
	public SurveyFile deleteSurveyFile(long surveyFileId)
		throws PortalException, SystemException {
		return surveyFilePersistence.remove(surveyFileId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SurveyFile deleteSurveyFile(SurveyFile surveyFile)
		throws SystemException {
		return surveyFilePersistence.remove(surveyFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SurveyFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return surveyFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return surveyFilePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return surveyFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SurveyFile fetchSurveyFile(long surveyFileId)
		throws SystemException {
		return surveyFilePersistence.fetchByPrimaryKey(surveyFileId);
	}
	 ...
	 */
	@Override
	public SurveyFile getSurveyFile(long surveyFileId)
		throws PortalException, SystemException {
		return surveyFilePersistence.findByPrimaryKey(surveyFileId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return surveyFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SurveyFile> getSurveyFiles(int start, int end)
		throws SystemException {
		return surveyFilePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSurveyFilesCount() throws SystemException {
		return surveyFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SurveyFile updateSurveyFile(SurveyFile surveyFile)
		throws SystemException {
		return surveyFilePersistence.update(surveyFile);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.lc.survey.model.SurveyFile",
			surveyFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.lc.survey.model.SurveyFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = surveyFilePersistence.getDataSource();
	...
	private SurveyFileLocalServiceClpInvoker _clpInvoker = new SurveyFileLocalServiceClpInvoker();
}